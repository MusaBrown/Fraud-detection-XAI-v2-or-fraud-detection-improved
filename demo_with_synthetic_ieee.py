...
class IEEECISSyntheticGenerator:
    """Generate realistic synthetic IEEE-CIS-like fraud data."""
    ...
    def generate(self) -> pd.DataFrame:
        """Generate synthetic IEEE-CIS data with realistic fraud patterns."""
...
def main():
    ...
    logger.info("Using Realistic Synthetic IEEE-CIS Data")
    logger.info("=" * 80)
    
    # 1. Generate Data
    logger.info("\n[1/6] Generating synthetic IEEE-CIS data...")
    generator = IEEECISSyntheticGenerator(n_samples=20000, fraud_rate=0.035)
